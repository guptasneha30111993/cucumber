...
public class BookStepDefinitions {
	...
	public void a_book_exists_with_isbn(String isbn){
		request = given().param("q", "isbn" + isbn).log().all();
	}
	...
	public void response_equals(int totalItem){
		
		response.then().assertThat().body("totalItems",equalTo(totalItem));
		 ...
		 * else{ json.body(field.getKey(), equalTo(field.getValue())); } }
		 */
	}
